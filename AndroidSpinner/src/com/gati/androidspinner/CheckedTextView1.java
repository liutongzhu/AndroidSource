...
public class CheckedTextView1 extends TextView implements Checkable {
    ...
    public CheckedTextView1(Context context) {
        this(context, null);
    }

    public CheckedTextView1(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.checkedTextViewStyle);
    }

    public CheckedTextView1(Context context, AttributeSet attrs, int defStyle) {
